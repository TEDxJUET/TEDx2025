      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-6">
            ...
            In the spirit of 'Ideas Worth Spreading', TED has created TEDx, which is a program of
            local, self-organized events that bring people together to share a TED-like
            experience. Our event is called TEDxJUET where x = independently organized TED
            event.                    
            </p>
          ...
          <div className="md:col-span-3 md:flex md:items-start md:justify-start md:flex-col hidden">
            ...
            <ul className="space-y-2 text-[#bbb] ">
              ...
              <li className="transform hover:translate-x-2 transition-transform duration-300">
                <Link href="/Speaker" className="hover:text-red-600 transition-colors flex items-center">
                  <span className="mr-2 text-xs opacity-0 group-hover:opacity-100 transition-opacity">▶</span>
                  Speakers
                </Link>
              </li>
