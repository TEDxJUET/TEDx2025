        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-6">
            ...
            <p className="text-gray-600 text-sm mb-6">
              In the spirit of "Ideas Worth Spreading", TED has created TEDx, which is a program of local,
            ...
            <div className="flex space-x-3 mt-4">
              <Link
                href="#"
                className="bg-gray-100 hover:bg-red-600 hover:text-white p-2 rounded-full transition-colors duration-300 transform hover:scale-110"
              >
                <Facebook size={18} />
